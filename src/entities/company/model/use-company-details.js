/**
 * @file DATA layer: single company CRUD (get, edit, status, delete).
 * @module entities/company/model/use-company-details
 */
...
/**
 * Bitta kompaniya ma'lumotlarini yuklaydi va CRUD operatsiyalarini bajaradi.
 * @param {string|number} id - Kompaniya ID si
 * @returns {{ details: object|null, notFound: boolean, error: string|null, getLoading: boolean, editLoading: boolean, statusLoading: boolean, deleteLoading: boolean, get: Function, edit: Function, toggleStatus: Function, remove: Function }}
 */
